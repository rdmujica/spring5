...
public class ClienteRestController {
	...
	public ResponseEntity<?> show(@PathVariable(name = "id") Long id) {
		...
		try {
			...
			String error = e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage());
			return responseEntity("Error al realizar la consulta en la base de datos", error, INTERNAL_SERVER_ERROR);
		}
		if (cliente == null) {
	...
	public ResponseEntity<?> create(@RequestBody Cliente cliente) {
		...
		try {
			...
			return responseEntity("Error al realizar el insert en la base de datos", error, INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<?> update(@PathVariable(name = "id") Long id, @RequestBody Cliente cliente) {
		...
		try {
			...
			String error = e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage());
			return responseEntity("Error al realizar la actualizacion en la base de datos", error,
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		try {
			...
			String error = e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage());
			return responseEntity("Error al eliminar la actualizacion en la base de datos", error,
					INTERNAL_SERVER_ERROR);
		}
	...
	private static ResponseEntity<Map<String, Object>> responseEntity(String mensaje, String error, HttpStatus status) {
