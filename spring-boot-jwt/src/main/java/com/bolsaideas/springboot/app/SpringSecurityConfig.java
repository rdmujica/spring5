...
import com.bolsaideas.springboot.app.auth.service.IJWTService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/", "/css/**", "/js/**", "/images/**", "/listar","/h2-console/**","/locale","/clientes-rest").permitAll()
